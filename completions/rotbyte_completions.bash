_rotbyte() {
    ...
    opts="--check --report --accept --accept-all --import --workers --quiet --skip-missing --include-hidden --exclude --db --export --json --budget --due --track --track-setup --status --repair --untrack --untrack-all --clear-logs --docs --every --full-at --notify --notify-setup --version --help"
